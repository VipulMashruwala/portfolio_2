...
class Internship(APIView):
    def get(self, request):
        return Response(data["internships"], content_type = 'application/json')
...
class ContactData(APIView):
    def post(self, request):
        ...
        if name == "" or email == "" or subject == "" or message == "":
            ...
            lst = email.split('@')
            if lst[-1] in ['gmail.com','outlook.com','hotmail.com']:
                contact_data = {
                    'name' : name,
                    'email' : email,
                    'subject' : subject,
                ...
                requests.post('https://portfolio-5dc14-default-rtdb.firebaseio.com/data.json',
                json = contact_data)
                ...
                recipient_list=['mashruwala.vipul@gmail.com'])
